<div id="userCampaignBulkModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 px-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div class="flex items-center justify-between px-4 py-3 border-b border-secondary/20">
            <div>
                <p class="text-xs text-gray-500">Assign selected users</p>
                <h4 class="text-base font-semibold text-foreground" id="userCampaignBulkTitle">0 users selected</h4>
            </div>
            <button type="button" id="userCampaignBulkClose" class="p-2 rounded hover:bg-secondary/10" aria-label="Close bulk assign modal">
        ...
        <form id="userCampaignBulkForm" class="px-4 py-4 space-y-4">
            ...
            <div class="space-y-2">
                <label for="userCampaignBulkSelect" class="text-sm font-medium text-gray-700">Campaign</label>
                <select id="userCampaignBulkSelect" name="campaign_id" class="w-full border border-secondary/40 rounded-md px-3 py-2 text-sm focus:border-primary focus:ring-1 focus:ring-primary/20">
            ...
            <p id="userCampaignBulkFeedback" class="text-sm text-red-600 hidden"></p>

            <div class="flex justify-end gap-3">
                <button type="button" id="userCampaignBulkCancel" class="px-4 py-2 text-sm font-medium text-secondary border border-secondary/40 rounded-md hover:bg-secondary/10">
                    Cancel
                </button>
                <button type="submit" id="userCampaignBulkSave" class="px-4 py-2 text-sm font-semibold text-white bg-primary rounded-md hover:bg-primary/90">
                    Assign
                </button>
            </div>
        </form>
